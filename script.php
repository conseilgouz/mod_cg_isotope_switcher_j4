<?php
/**
* CG Isotope Switcher Module  - Joomla 4.0.0 Module 
* Version			: 2.0.1
* Package			: CG Isotope Switcher
...
class mod_cg_isotope_switcherInstallerScript
{
	private $min_joomla_version      = '3.9.0';
	private $min_php_version         = '7.2';
	private $name                    = 'CG Isotope Switcher';
	private $exttype                 = 'module';
	private $extname                 = 'cg_isotope_switcher';
	private $previous_version        = '';
	private $dir           = null;
	private $installerName = 'cg_isotopeswitcherinstaller';
	...
	private function postinstall_cleanup() {
		...
		$query = $db->getQuery(true)
			->delete('#__update_sites')
			->where($db->quoteName('location') . ' like "%conseilgouz.com/updates/mod_cg_isotope%"');
		$db->setQuery($query);
		$db->execute();
